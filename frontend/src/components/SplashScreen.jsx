...
const SplashScreen = ({ onFinish }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 overflow-hidden transition-opacity duration-700 ${exit ? 'opacity-0' : 'opacity-100'}`}>
      {/* Main Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-red-800 to-red-900">
        ...
        {/* Main Content */}
        <div className={`relative h-full flex flex-col items-center justify-center text-white transition-transform duration-700 ${exit ? '-translate-y-full' : ''}`}>
          {/* Department Logo */}
